...
--     symmetric key supplied at runtime from Azure Key Vault (never stored in DB).
-- =====================================================================
...
CREATE TABLE recommendation (
    ...
    composite_signal     NUMERIC(4,2) NOT NULL,             -- [-2,2] weighted composite
    ...
    CONSTRAINT ck_rec_signal_range CHECK (composite_signal BETWEEN -2 AND 2),
