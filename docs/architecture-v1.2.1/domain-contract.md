...
Array, **always non-empty** (CHECK in schema; contract in OpenAPI `PerModuleBreakdown`):
```json
[
  { "module": "technical",   "signal_score": 1.20, "weight_assigned": 0.30, "weight_effective": 0.43, "status": "ok" },
  { "module": "fundamental", "signal_score": 0.50, "weight_assigned": 0.30, "weight_effective": 0.43, "status": "ok" },
  { "module": "chip",        "signal_score": -0.10,"weight_assigned": 0.25, "weight_effective": 0.14, "status": "ok" },
  { "module": "news",        "signal_score": null, "weight_assigned": 0.15, "weight_effective": 0.00, "status": "unavailable" }
]
```
`module ∈ {technical,fundamental,chip,news}` (fixed order recommended). Unavailable ⇒ `signal_score:null`, `weight_effective:0`.
